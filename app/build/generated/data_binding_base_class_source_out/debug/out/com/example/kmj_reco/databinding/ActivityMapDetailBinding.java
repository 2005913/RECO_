...
public final class ActivityMapDetailBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView trashcanFulladdress;

  private ActivityMapDetailBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageView imageView7, @NonNull TextView textView6,
      @NonNull TextView trashcanFulladdress) {
    this.rootView = rootView;
    this.imageView7 = imageView7;
    this.textView6 = textView6;
    this.trashcanFulladdress = trashcanFulladdress;
  }
  ...
  public static ActivityMapDetailBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.trashcan_fulladdress;
      TextView trashcanFulladdress = rootView.findViewById(id);
      if (trashcanFulladdress == null) {
        break missingId;
      }

      return new ActivityMapDetailBinding((ConstraintLayout) rootView, imageView7, textView6,
          trashcanFulladdress);
    }
